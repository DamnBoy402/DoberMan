...
class dobconf:
    def __init__(self):
        ...
        self.headers = {"User-Agent": "DoberMan/1.0 (+https://example.com/doberman)"}
    ...
    def ekstrakurl(self, url, base_url):
        try:
            ...
            links = {
                ...
                if self.validator(urljoin(base_url, a["href"]))
            }
    ...
    def crawl(self, url, max_depth=3, current_depth=1):
        ...
        try:
            links, _ = self.ekstrakurl(url, url)
...
def main2():
    ...
    try:
        with ThreadPoolExecutor(max_workers=args.threads) as executor:
            future = executor.submit(crawler.crawl, args.url, args.depth)
            future.result()
